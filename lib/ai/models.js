...
export const MODELS = [
  ...
  desc:          "Fastest & cheapest. Built for high-volume, low-latency tasks.",
  ...
  
  {
    ...
    label:       "Gemini Flash",
    desc:        "Fast, affordable, and reliable. Great for everyday searches.",
    strengths:   ["speed", "cost"],
    costIn:      0.15,
    costOut:     0.60,
    badge:       "Fast",
  },
  {
    ...
    label:       "Gemini Pro",
    desc:        "Google's smartest model. Best for complex, multi-step queries.",
    strengths:   ["quality"],
    costIn:      1.25,
    costOut:     10.0,
    badge:       "Pro",
  ...
  // },
  {
    ...
    desc:        "Sharp reasoning at minimal cost. Great for analytical tasks.",
  ...
  },
  {
    ...
    desc:        "OpenAI's open-weight 120B. Solid instruction-following at low cost.",
    strengths:   ["cost", "quality"],
    costIn:      0.55,
    costOut:     2.19,
    badge:       "Budget",
  },
  {
    ...
    desc:        "Meta's best open-source model. Reliable, multilingual, and free.",
    strengths:   ["cost", "quality"],
    costIn:      0.55,
    costOut:     2.19,
    badge:       "Budget",
